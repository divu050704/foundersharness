...
export const INITIAL_AGENTS = [
  {
    ...
    aiModel: "Orchestrator Core",
    avatarColor: "#f59e0b",
    avatarBg: "bg-amber-500/20 text-amber-500 border-amber-500",
    status: "working",
    currentThought: "Orchestrating startup vision into action! Coordinating founder day plan & social calendar.",
    activeTask: "Delegating daily startup tasks & monitoring device-hook session",
    achievementTitle: "World's Best Founder Co-pilot 🏆",
    achievementScore: 9999,
    tasksCompleted: 154,
    linesWritten: 14200,
    coffeeCups: 8,
    memoryItems: [
    ...
    logs: [
      ...
      "[DELEGATE] Assigned LinkedIn & X post batch to Social Agent (Sophia & Lucas)",
      "[DELEGATE] Triggered non-dilutive grant crawl for Victor"
    ]
  },
  {
    id: "sophia",
    ...
    achievementTitle: "Master Content Calendar Artist 🏆",
  ...
  },
  {
    ...
    aiModel: "Browser Automation Core",
    avatarColor: "#06b6d4",
    ...
    achievementTitle: "Stealth Browser Automation Award 🏆",
    achievementScore: 1380,
    tasksCompleted: 84,
    linesWritten: 12100,
    coffeeCups: 6,
    memoryItems: [
  ...
  },
  {
    ...
    aiModel: "Capital & Grants Core",
    avatarColor: "#10b981",
    avatarBg: "bg-emerald-500/20 text-emerald-500 border-emerald-500",
    status: "working",
    currentThought: "Relentless execution. $100K Non-dilutive Grant match found!",
    activeTask: "Scouting NSF, SBIR, AWS Credits & Angel Investment opportunities",
    achievementTitle: "Top Capital & Grant Exterminator 🏆",
    achievementScore: 1620,
    tasksCompleted: 104,
    linesWritten: 15400,
    coffeeCups: 4,
    memoryItems: [
  ...
  },
  {
    ...
    aiModel: "Focus & Productivity Core",
    avatarColor: "#3b82f6",
    avatarBg: "bg-blue-500/20 text-blue-500 border-blue-500",
    status: "thinking",
    currentThought: "Focus time locked in. Blocking 3 hours of uninterrupted deep work.",
    activeTask: "Optimizing founder calendar, blocking focus time & priority tasks",
    achievementTitle: "Pretzels & Uninterrupted Focus Award 🏆",
    achievementScore: 1120,
    tasksCompleted: 78,
    linesWritten: 8900,
    coffeeCups: 3,
    memoryItems: [
  ...
  },
  {
    ...
    aiModel: "Networking & Events Core",
    avatarColor: "#a855f7",
    ...
    achievementTitle: "Hottest Networking Scout Award 🏆",
  ...
  },
  {
    ...
    aiModel: "Safety & Compliance Core",
    avatarColor: "#64748b",
    ...
    achievementTitle: "Extreme Repetitive Stress & Safety Award 🏆",
  ...
  },
  {
    ...
    aiModel: "Budget & Audit Core",
    avatarColor: "#ef4444",
    avatarBg: "bg-red-500/20 text-red-500 border-red-500",
    status: "working",
    currentThought: "Audits complete. Auditing monthly SaaS & LLM token spend.",
    activeTask: "Tracking startup burn rate, API costs & software subscriptions",
    achievementTitle: "Tightest Startup Budgeter Award 🏆",
    achievementScore: 1240,
    tasksCompleted: 69,
    linesWritten: 5800,
    coffeeCups: 3,
    memoryItems: [
